            ...
            <table class="tbl-default">
                <tr>
                    ...
                    <asp:DropDownList ID="ddlCategory" runat="server" CssClass="input-with-feedback form-control" TabIndex="0" ValidationGroup="Item" >
                        ...
                        <asp:ListItem Text="Fruit" Value="2"></asp:ListItem>
                    </asp:DropDownList>
                   ...
                   <tr>
                    ...
                    <td class="td2">
                    <asp:TextBox ID="txtItemName" runat="server" CssClass="input-with-feedback form-control" TabIndex="1" ValidationGroup="Item" ></asp:TextBox>                        
                ...
                <th class="td1">
                    ...
                    <td class="td2">
                    <asp:TextBox ID="txtMarg1Kg" runat="server" CssClass="input-with-feedback form-control" TabIndex="3" ValidationGroup="Item"></asp:TextBox>                        
                ...
                <th class="td1">
                    ...
                    <td class="td2">
                    <asp:TextBox ID="txtMarg5Kg" runat="server" CssClass="input-with-feedback form-control" TabIndex="4" ValidationGroup="Item" ></asp:TextBox>                        
                ...
                <th class="td1">
                    ...
                    <td class="td2">
                    <asp:TextBox ID="txtMarg25Kg" runat="server" CssClass="input-with-feedback form-control" TabIndex="5"  ValidationGroup="Item"></asp:TextBox>                        
                ...
                <th class="td1">
                    ...
                    <td class="td2">
                    <asp:TextBox ID="txtMarg50Kg" runat="server" CssClass="input-with-feedback form-control" TabIndex="6" ValidationGroup="Item" ></asp:TextBox>                        
                ...
                <tr>
                <td colspan="2" > <center><asp:Button ID="btnSaveItem" runat="server" CssClass="btn btn-primary" Text="Save Item" TabIndex="7" ValidationGroup="Item" /></center> </td>
                </tr>
