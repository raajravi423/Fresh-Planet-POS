...
(function () {
    ...
    DayPilotCalendar.Calendar = function (id) {
        ...
        this.businessBeginsHour = 6;
        this.businessEndsHour = 22;
            ...
            $c.nav.scrollable.onmousemove = function (ev) {
                ...
                if (DayPilotCalendar.resizing) {
                    ...
                    if (DayPilotCalendar.resizing.dpBorder === 'bottom') {
                        ...
                        if (DayPilotCalendar.originalTop + $0U > $04) $0U = $04 - DayPilotCalendar.originalTop;
        ...
        this.drawHeader = function () {
            ...
            if (!$0y) {
                ...
                if (!this.fasterDispose) DayPilot.pu($0H.firstChild);
            };
